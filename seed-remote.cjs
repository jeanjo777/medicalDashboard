...
const MEDIC_ID = '7e91b9ae-708e-4102-92ef-d303faf51245';
...
async function seed() {
  ...
  const patients = [
    { first_name:'Amadou', last_name:'Diallo', name:'Amadou Diallo', date_of_birth:'1978-03-15', age:48, gender:'M', blood_type:'A+', phone:'+225 07 01 02 03', email:'amadou.diallo@email.com', address:'Cocody, Abidjan', emergency_contact:'Fatou Diallo', medical_history:'Hypertension arterielle depuis 2015', allergies:'Penicilline', primary_pathology:'Hypertension', status:'active', riskScore:75, last_visit:'2026-05-04', poids:82, taille:175, tension_arterielle:'16/10' },
    { first_name:'Fatoumata', last_name:'Kone', name:'Fatoumata Kone', date_of_birth:'1985-07-22', age:40, gender:'F', blood_type:'O+', phone:'+225 07 11 22 33', email:'fatoumata.kone@email.com', address:'Plateau, Abidjan', emergency_contact:'Ibrahim Kone', medical_history:'Diabete type 2', allergies:'Aucune', primary_pathology:'Diabete', status:'active', riskScore:82, last_visit:'2026-05-05', poids:68, taille:162, tension_arterielle:'13/8' },
    { first_name:'Moussa', last_name:'Traore', name:'Moussa Traore', date_of_birth:'1990-11-08', age:35, gender:'M', blood_type:'B+', phone:'+225 05 44 55 66', email:'moussa.traore@email.com', address:'Yopougon, Abidjan', emergency_contact:'Awa Traore', medical_history:'Asthme chronique', allergies:'Aspirine', primary_pathology:'Asthme', status:'active', riskScore:45, last_visit:'2026-05-03', poids:74, taille:180, tension_arterielle:'12/7' },
    { first_name:'Aminata', last_name:'Coulibaly', name:'Aminata Coulibaly', date_of_birth:'1972-01-30', age:54, gender:'F', blood_type:'AB+', phone:'+225 01 77 88 99', email:'aminata.coulibaly@email.com', address:'Marcory, Abidjan', emergency_contact:'Seydou Coulibaly', medical_history:'Insuffisance cardiaque, HTA', allergies:'Sulfamides', primary_pathology:'Cardiologie', status:'active', riskScore:91, last_visit:'2026-05-06', poids:71, taille:158, tension_arterielle:'15/9' },
    { first_name:'Ibrahim', last_name:'Sangare', name:'Ibrahim Sangare', date_of_birth:'1995-05-12', age:31, gender:'M', blood_type:'O-', phone:'+225 07 22 33 44', email:'ibrahim.sangare@email.com', address:'Treichville, Abidjan', emergency_contact:'Mariam Sangare', medical_history:'RAS', allergies:'Aucune', primary_pathology:null, status:'active', riskScore:15, last_visit:'2026-04-28', poids:70, taille:172, tension_arterielle:'12/8' },
    ...
    { first_name:'Seydou', last_name:'Bamba', name:'Seydou Bamba', date_of_birth:'1965-12-03', age:60, gender:'M', blood_type:'B-', phone:'+225 01 88 99 00', email:'seydou.bamba@email.com', address:'Adjame, Abidjan', emergency_contact:'Rokia Bamba', medical_history:'BPCO, Diabete type 2, HTA', allergies:'Aucune', primary_pathology:'Pneumologie', status:'active', riskScore:88, last_visit:'2026-05-05', poids:90, taille:170, tension_arterielle:'17/11' },
    { first_name:'Awa', last_name:'Toure', name:'Awa Toure', date_of_birth:'1992-04-18', age:34, gender:'F', blood_type:'O+', phone:'+225 07 33 44 55', email:'awa.toure@email.com', address:'Cocody, Abidjan', emergency_contact:'Bakary Toure', medical_history:'Grossesse 7 mois', allergies:'Aucune', primary_pathology:'Gynecologie', status:'active', riskScore:40, last_visit:'2026-05-06', poids:72, taille:168, tension_arterielle:'11/7' },
    { first_name:'Bakary', last_name:'Konate', name:'Bakary Konate', date_of_birth:'1980-08-07', age:45, gender:'M', blood_type:'A+', phone:'+225 05 66 77 88', email:'bakary.konate@email.com', address:'Koumassi, Abidjan', emergency_contact:'Fanta Konate', medical_history:'Ulcere gastrique, reflux', allergies:'AINS', primary_pathology:'Gastro-enterologie', status:'active', riskScore:52, last_visit:'2026-04-30', poids:78, taille:176, tension_arterielle:'13/8' },
    { first_name:'Kadiatou', last_name:'Sylla', name:'Kadiatou Sylla', date_of_birth:'1998-02-14', age:28, gender:'F', blood_type:'AB-', phone:'+225 01 99 00 11', email:'kadiatou.sylla@email.com', address:'Riviera, Abidjan', emergency_contact:'Mamadou Sylla', medical_history:'Eczema atopique', allergies:'Latex, Nickel', primary_pathology:'Dermatologie', status:'active', riskScore:22, last_visit:'2026-04-25', poids:58, taille:160, tension_arterielle:'11/7' },
    { first_name:'Drissa', last_name:'Camara', name:'Drissa Camara', date_of_birth:'1975-06-20', age:50, gender:'M', blood_type:'B+', phone:'+225 07 44 55 66', email:'drissa.camara@email.com', address:'Plateau, Abidjan', emergency_contact:'Sitan Camara', medical_history:'AVC ischemique 2024, HTA', allergies:'Aucune', primary_pathology:'Neurologie', status:'active', riskScore:95, last_visit:'2026-05-06', poids:85, taille:178, tension_arterielle:'15/10' },
    { first_name:'Rokia', last_name:'Diakite', name:'Rokia Diakite', date_of_birth:'1983-10-11', age:42, gender:'F', blood_type:'O+', phone:'+225 05 77 88 99', email:'rokia.diakite@email.com', address:'Marcory, Abidjan', emergency_contact:'Oumar Diakite', medical_history:'Polyarthrite rhumatoide', allergies:'Methotrexate', primary_pathology:'Rhumatologie', status:'active', riskScore:63, last_visit:'2026-05-02', poids:63, taille:164, tension_arterielle:'12/8' },
    ...
    { first_name:'Sitan', last_name:'Cisse', name:'Sitan Cisse', date_of_birth:'2000-07-04', age:25, gender:'F', blood_type:'O+', phone:'+225 07 55 66 77', email:'sitan.cisse@email.com', address:'Yopougon, Abidjan', emergency_contact:'Papa Cisse', medical_history:'RAS', allergies:'Aucune', primary_pathology:null, status:'active', riskScore:10, last_visit:'2026-04-20', poids:52, taille:157, tension_arterielle:'11/7' },
    ...
    { first_name:'Oumou', last_name:'Sacko', name:'Oumou Sacko', date_of_birth:'1993-01-22', age:33, gender:'F', blood_type:'A-', phone:'+225 01 44 55 66', email:'oumou.sacko@email.com', address:'Treichville, Abidjan', emergency_contact:'Adama Sacko', medical_history:'Hypothyroidie', allergies:'Aucune', primary_pathology:'Endocrinologie', status:'active', riskScore:35, last_visit:'2026-04-29', poids:60, taille:163, tension_arterielle:'12/7' },
    { first_name:'Adama', last_name:'Diabate', name:'Adama Diabate', date_of_birth:'1987-08-30', age:38, gender:'M', blood_type:'O+', phone:'+225 07 66 77 88', email:'adama.diabate@email.com', address:'Abobo, Abidjan', emergency_contact:'Fatoumata Diabate', medical_history:'Drepanocytose SS', allergies:'Aucune', primary_pathology:'Hematologie', status:'active', riskScore:72, last_visit:'2026-05-03', poids:67, taille:169, tension_arterielle:'11/7' },
    { first_name:'Fanta', last_name:'Sissoko', name:'Fanta Sissoko', date_of_birth:'1991-12-08', age:34, gender:'F', blood_type:'B+', phone:'+225 05 99 00 11', email:'fanta.sissoko@email.com', address:'Koumassi, Abidjan', emergency_contact:'Modibo Sissoko', medical_history:'Epilepsie bien controlee', allergies:'Carbamazepine', primary_pathology:'Neurologie', status:'active', riskScore:48, last_visit:'2026-05-01', poids:56, taille:161, tension_arterielle:'12/7' },
    { first_name:'Modibo', last_name:'Sidibe', name:'Modibo Sidibe', date_of_birth:'1982-04-02', age:44, gender:'M', blood_type:'AB+', phone:'+225 01 11 22 33', email:'modibo.sidibe@email.com', address:'Riviera, Abidjan', emergency_contact:'Kadiatou Sidibe', medical_history:'Hepatite B chronique', allergies:'Aucune', primary_pathology:'Hepatologie', status:'active', riskScore:65, last_visit:'2026-05-02', poids:73, taille:177, tension_arterielle:'13/8' },
    { first_name:'Aissatou', last_name:'Barry', name:'Aissatou Barry', date_of_birth:'1996-06-17', age:29, gender:'F', blood_type:'O-', phone:'+225 07 77 88 99', email:'aissatou.barry@email.com', address:'Cocody, Abidjan', emergency_contact:'Alpha Barry', medical_history:'Allergie severe aux arachides', allergies:'Arachides, fruits a coque', primary_pathology:'Allergologie', status:'active', riskScore:55, last_visit:'2026-04-27', poids:54, taille:159, tension_arterielle:'11/7' },
  ];
  const pIds = [];
