            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                <div className="flex items-center gap-1">
                  ...
                  <span>{summary.age} ans • {summary.gender === 'male' ? 'Homme' : summary.gender === 'female' ? 'Femme' : summary.gender === 'child_boy' ? 'Enfant (Garçon)' : summary.gender === 'child_girl' ? 'Enfant (Fille)' : 'Autre'}</span>
                </div>
                <div className="flex items-center gap-1">
