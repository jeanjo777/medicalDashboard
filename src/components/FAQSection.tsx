...
import { ChevronDown, HelpCircle, Clock, CreditCard, MapPin, Phone, Shield } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 font-heading leading-tight">
            Vos <span className="text-teal-700">questions</span> les plus courantes
          </h2>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className={`w-9 h-9 rounded-xl ${item.iconBg} border flex items-center justify-center flex-shrink-0`}>
                ...
                <div className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-300 ${
                  ...
                  <ChevronDown className={openItems.includes(index) ? 'text-teal-600' : 'text-gray-400'} size={16} />
                </div>
              </button>
        ...
        <div className="mt-12 sm:mt-16">
          <div className="bg-white rounded-2xl border border-gray-100 p-8 sm:p-10 shadow-sm max-w-2xl mx-auto text-center">
            <div className="w-14 h-14 bg-teal-50 border border-teal-200/50 rounded-2xl flex items-center justify-center mx-auto mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                ...
                className="btn-secondary inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold"
              >
                WhatsApp
              </a>
            </div>
