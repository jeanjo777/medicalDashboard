          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {activeBadges.map((badge) => (
                <span
                  key={badge.key}
                  className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-500/20 border border-blue-300 dark:border-blue-500/30 text-blue-700 dark:text-blue-300 rounded-full text-sm"
                >
                  {badge.label}
                  <button
                    onClick={() => {
